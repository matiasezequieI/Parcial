...
public class Carro extends Veiculo {
	...
	public Carro(String placa, String modelo, String cpf, String nome, String telefone, Date data) {
		super(placa, modelo, cpf, nome, telefone, data);
	}

	public static final double VALOR_HORA_ADICIONAL = 2.50;
	...
	public double calculaValorEstacionamento() {
		...
		if(tempoPermanecia < 1) {
			...
			return Veiculo.VALOR_PRIMEIRA_HORA + (horasAdicionais * Carro.VALOR_HORA_ADICIONAL);
		}
	}
